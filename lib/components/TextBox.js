...
var TextBox = exports.TextBox = function (_Component) {
  ...
  _createClass(TextBox, [{
    key: 'getTextBoxType',
    value: function getTextBoxType(type) {
      switch (type) {
        case 'numeric':
          return 'number';
        default:
    ...
    value: function render() {
      var textBoxType = this.getTextBoxType(this.props.obs.type);
      return _react2.default.createElement('input', { defaultValue: this.props.obs.value, type: textBoxType });
    }
  }]);
