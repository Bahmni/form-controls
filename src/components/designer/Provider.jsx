...
export class ProviderDesigner extends Component {
  ...
  componentDidMount() {
    ...
    const defaultUrl = '/openmrs/ws/rest/v1/provider?v=custom:(id,name,uuid)';
        ...
        attributes: [
          {
            name: 'URL',
            dataType: 'string',
            defaultValue: '/openmrs/ws/rest/v1/provider?v=custom:(id,name,uuid)',
            elementType: 'text',
          },
          {
            name: 'style',
...
ComponentStore.registerDesignerComponent('ProviderObsHandler', descriptor);
