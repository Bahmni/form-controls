...
export const Welcome = {
  ...
  render: () => (
    <div style={{ fontFamily: 'sans-serif', padding: '40px', maxWidth: '800px' }}>
      ...
      <div style={{ background: '#f4f4f4', border: '1px solid #ddd', borderRadius: '4px', padding: '16px 20px', marginBottom: '8px' }}>
        <h3 style={{ fontSize: '1.05rem', marginBottom: '8px' }}>Getting Started</h3>
